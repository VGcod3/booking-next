...
export default function SortingButtons({ showFullRoomsData, setShowFullRoomsData, setMobileFiltersOpen }: SortingButtonProps) {
        ...
        <div className="flex items-center">
            ...
            {showFullRoomsData ? (
                <button
                    ...
                    className="-m-2 ml-5 p-2 text-gray-400 hover:text-gray-500 sm:ml-7 focus:ring-indigo-500active:shadow-indigo-500 focus:outline-offset-4"
                >
